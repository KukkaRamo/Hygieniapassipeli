...
public enum ProcessedFoodType {
    ...
    JAUHELIHA (FoodType.MEAT, "Jauheliha", 0, 4, 0, 4, true),
    JAUHEMAKSA (FoodType.MEAT, "Jauhettu maksa", 0, 4, 0, 4, true),
    JAUHEKANA (FoodType.BIRD, "Jauhetut siipikarjatuotteet", 0, 4, 0, 4, true),
    ...
    ISKUKUUMENNETTUMAITOTUOTE (FoodType.MILK, "Iskukuumennettu maitotuote", Food.lowlimittemp, Food.highlimittemp, Food.lowlimittemp, Food.highlimittemp, false),
    ...
    IDUT (FoodType.MILK, "Idut", 6, 6, 6, 6, true),
    PALOITELLUTKASVIKSET (FoodType.MILK, "Paloitellut kasvikset", 6, 6, 6, 6, true),
    ELÄVÄTNILVIÄISET (FoodType.MILK, "Elävät simpukat", 6, 6, 6, 6, true),
    SUSHI (FoodType.MILK, "Sushi", 6, 6, 6, 6, true),
    KOKONAINENKALAKUKKO (FoodType.BREAD, "Kalakukko", 18, Food.highlimittemp, 18, Food.highlimittemp, true),
    VOILEIPA (FoodType.BREAD, "Voileipä", 18, Food.highlimittemp, 18, Food.highlimittemp, true),
    LEIPA (FoodType.BREAD, "Leipä", 18, Food.highlimittemp, 18, Food.highlimittemp, false),
    TUORELEIVOS (FoodType.BREAD, "Helposti pilaantuva leivos", 18, Food.highlimittemp, 18, Food.highlimittemp, true),
    KUIVALEIVOS (FoodType.BREAD, "Kuiva leivos", 18, Food.highlimittemp, 18, Food.highlimittemp, false),
    KOKONAINENKASVI (FoodType.PLANT, "Kokonainen kasvi", 18, Food.highlimittemp, 18, Food.highlimittemp, false),
    ...
    KUUMENNETTURUOKA (FoodType.PLANT, "Kuumennettu ruoka", 6, 6, 6, 6, true);  
    ...
    int lowProductionTemp;
    int highProductionTemp;
    boolean easilySpoiling;
    
    ProcessedFoodType (FoodType pfood, String pcontent, int plowtemp, int phightemp, int plowprodtemp, int phighprodtemp, boolean peasilyspoiling) {
        this.foodType = pfood;
        this.content = pcontent;
        this.lowTemp = plowtemp;
        this.highTemp = phightemp;
        this.lowProductionTemp = plowprodtemp;
        this.highProductionTemp = phighprodtemp;
    ...
    public int getLowProductionTemp() {return this.lowProductionTemp; }
    public int getHighProductionTemp() {return this.highProductionTemp; }
